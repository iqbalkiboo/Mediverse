...
const ContentLab = () => {
  ...
  const {
    data: { role, metadata, params, laboratoriums, dataVaccinations },
    method: {
      handleChangeSearch,
  ...
  useEffect(() => {
    ...
    if (params.status) handleListLaboratorium();
    handleDateValue();
  }, [dateRange.end]);
  ...
  return (
    <>
      ...
      <ModalConfirmationLab onSuccess={handleListLaboratorium} />
      ...
      <div className='mt-6'>
        ...
        <div className='mt-6'>
          <TableTransaction
            ...
            isLoading={laboratoriums.isLoading}
            isError={laboratoriums.isError}
            errMsg={laboratoriums.message}
          />
          <Pagination
