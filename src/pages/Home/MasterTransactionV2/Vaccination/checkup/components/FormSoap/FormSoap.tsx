...
const FormSoap = () => {
  ...
  useEffect(() => {
    const treatmentName = dataVaccinationDetail?.sales_order_detail?.items
  ...
  }, [dataVaccinationDetail?.sales_order_detail?.items]);
    ...
    <>
      <ModalSuccess
        ...
        onCancel={() => {
          ...
          navigate(`${ROUTES_TRANSACTION.VACCINATIONS}`);
        }}
      />
      <ModalError
        ...
        <div className='flex gap-2 justify-between mt-6'>
          <div className='w-1/3'>
            <Button
              ...
              onClick={() =>
                navigate(
                  `${ROUTES_TRANSACTION.VACCINATION_CHECKUP}/${id}/?tab=assessment`
                )
              }
            />
          </div>
