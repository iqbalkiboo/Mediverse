...
const ContentVaccination = () => {
  ...
  const {
    data: { metadata, params, vaccinations, dataVaccinations },
    method: {
      handleChangeSearch,
  ...
  useEffect(() => {
    ...
    if (params.status) handleGetListVaccination();
    handleDateValue();
  }, [dateRange.end]);
    ...
    return [
      {
        ...
        disableSortBy: true,
        Cell: ({ value }) => {
          return <CardVaccination data={value} />;
        },
      },
    ];
  }, []);
  ...
  return (
    <>
      ...
      <ModalConfirmationVaccination onSuccess={handleGetListVaccination} />
