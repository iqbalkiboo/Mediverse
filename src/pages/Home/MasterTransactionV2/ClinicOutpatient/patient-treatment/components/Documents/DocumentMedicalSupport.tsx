...
import { calculateBirthDate } from '@/utils/formatDate';
      ...
      <Page size='A4' style={styles.page}>
        <View style={[styles.container, { marginBottom: 5 }]} fixed>
          <View style={[styles.section, { justifyContent: 'space-between' }]}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>Surat Rujukan Rawat Jalan</Text>
        ...
        <View style={[styles.container, { marginBottom: 5 }]}>
          <View style={[styles.section, { marginBottom: 10 }]}>
            <Text style={styles.baseText}>Kepada Yth</Text>
          </View>
          <View style={[styles.section, { marginBottom: 10 }]}>
            <Text style={[styles.baseText, { width: 130 }]}>Dokter</Text>
            <Text style={styles.baseTextBold}>-</Text>
          </View>
          <View style={[styles.section, { marginBottom: 10 }]}>
            <Text style={[styles.baseText, { width: 130 }]}>Bagian</Text>
            <Text style={styles.baseTextBold}>Laboratorium</Text>
          </View>
          <View style={[styles.section, { marginBottom: 10 }]}>
            <Text style={[styles.baseText, { width: 130 }]}>Alamat</Text>
            <Text style={styles.baseTextBold}>
              {dataClinicOutpatient?.clinic?.address || '-'}
            </Text>
          </View>
          <View style={[styles.section, { marginBottom: 10 }]}>
            <Text style={[styles.baseText, { width: 130 }]}>Layanan</Text>
            <Text style={styles.baseTextBold}>
              Pemeriksaan/Pengobatan/Perawatan :
            </Text>
          </View>

          {formMedicalSupport.medicalSupport?.map((item, index) => (
            <View
              key={index}
              style={[styles.section, { marginBottom: 10, paddingLeft: 130 }]}
            >
              <Text style={styles.baseTextBold}>
                {index + 1}. {item.medicalSupport?.item_name || ''}
              </Text>
            </View>
          ))}

          <View style={styles.section}>
            <Text style={[styles.baseText, { width: 130 }]}>No Rujukan</Text>
            <Text style={styles.baseTextBold}>
              {dataClinicOutpatient?.no_medical_support || '-'}
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.container, { marginBottom: 5 }]}>
          ...
          <View style={styles.section}>
            <Text style={[styles.baseText, { width: 130 }]}>Keluhan</Text>
            <Text style={styles.baseTextBold}>-</Text>
          </View>
        </View>
...
export default DocumentMedicalSupport;
