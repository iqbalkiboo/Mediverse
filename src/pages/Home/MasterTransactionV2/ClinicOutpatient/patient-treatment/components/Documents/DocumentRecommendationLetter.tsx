...
const DocumentRecommendationLetter = () => {
      ...
      <Page size='A4' style={styles.page}>
        <View style={[styles.container, { marginBottom: 5 }]} fixed>
          <View style={[styles.section, { justifyContent: 'space-between' }]}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.titleText}>Surat Rujukan Keluar</Text>
        ...
        <View style={[styles.container, { marginBottom: 5 }]}>
          ...
          <View style={[styles.section, { marginBottom: 10 }]}>
            ...
            <Text style={styles.baseTextBold}>
              {formRecommendationLetter?.detailRefer?.hospital?.address || '-'}
            </Text>
          </View>
          <View style={[styles.section, { marginBottom: 10 }]}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.baseTextBold}>
              {dataClinicOutpatient?.no_recommendation_letter || '-'}
            </Text>
          </View>
        </View>
...
export default DocumentRecommendationLetter;
