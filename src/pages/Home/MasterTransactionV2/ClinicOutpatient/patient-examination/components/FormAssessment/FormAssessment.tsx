...
const FormAssessment = () => {
  ...
  const {
    data: { id, dataClinicOutpatientDetail, formCheckup, errors, isValid },
    method: {
        ...
        <div className='flex gap-2 justify-between mt-6'>
          <div className='w-1/3'>
            <Button
              ...
              onClick={() =>
                navigate(`${ROUTES_TRANSACTION.CLINIC_OUTPATIENT}`)
              }
            />
          </div>
          <div className='w-1/3'>
            <Button
              ...
              onClick={handleSubmit(() =>
                navigate(
                  `${ROUTES_TRANSACTION.CLINIC_OUTPATIENT_EXAMINATION}/${id}/?tab=soap`
                )
              )}
            />
          </div>
