...
const usePatientExamination = () => {
  ...
  const { clinicOutpatient, formCheckup } = useSelector(
    (state: RootStateOrAny) => state.clinicOutpatient
  );
...
export default usePatientExamination;
